...
class GUI:
    ...
    def __init__(self):
        ...
        # Create NoiseReductionApp
        self.logic = NoiseReductionApp(self.main_menu)
        self.logic.cap = self.cap  # share video stream 
        self.logic.root = self.main_menu  # allow  to manipulate the GUI
    ...
    def take_screenshot(self):
        self.clear_main_menu()
        tk.Label(self.main_menu, text="Press start to start detceting carcks").pack()
